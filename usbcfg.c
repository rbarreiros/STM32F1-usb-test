...
static const uint8_t vcom_configuration_descriptor_data[9+9+7+7] = {
  ...
  USB_DESC_ENDPOINT     (USBD1_DATA_AVAILABLE_EP | USB_RTYPE_DIR_DEV2HOST,       /* bEndpointAddress.*/
                         0x02,          /* bmAttributes (Bulk).             */
                         0x0040,        /* wMaxPacketSize.                  */
                         0x00),         /* bInterval.                       */
  /* Endpoint 1 Descriptor.*/
  USB_DESC_ENDPOINT     (USBD1_DATA_REQUEST_EP | USB_RTYPE_DIR_HOST2DEV,    /* bEndpointAddress.*/
                         0x02,          /* bmAttributes (Bulk).             */
                         0x0040,        /* wMaxPacketSize.                  */
                         0x00)          /* bInterval.                       */
};
